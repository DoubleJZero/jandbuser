...
public class QTbUserInfo extends EntityPathBase<TbUserInfo> {
    ...
    private static final long serialVersionUID = -1593814788L;

    public static final QTbUserInfo tbUserInfo = new QTbUserInfo("tbUserInfo");

    public final jandbuser.data.QBaseTimeEntity _super = new jandbuser.data.QBaseTimeEntity(this);
